...
00000000 <.data>:
    ...
    4624:	00000000 	nop
    4628:	3c02c38f 	lw	v1,572(s8)
    462c:	3002c48f 	lw	a0,560(s8)
    4630:	3402c28f 	lw	v0,564(s8)
    4634:	ff004230 	andi	v0,v0,0xff
    4638:	1000a2af 	sw	v0,16(sp)
    463c:	25388000 	move	a3,a0
    4640:	25306000 	move	a2,v1
    4644:	01000524 	li	a1,1
    4648:	5000c48f 	lw	a0,80(s8)
    464c:	f209000c 	jal	0x27c8
    4650:	00000000 	nop
    4654:	62000424 	li	a0,98
    4658:	3d0c000c 	jal	0x30f4
    465c:	00000000 	nop
    4660:	5802d08f 	lw	s0,600(s8)
    4664:	01000226 	addiu	v0,s0,1
    4668:	5802c2af 	sw	v0,600(s8)
    466c:	3002d18f 	lw	s1,560(s8)
    4670:	3402c28f 	lw	v0,564(s8)
    4674:	25204000 	move	a0,v0
    4678:	d614000c 	jal	0x5358
    467c:	00000000 	nop
    4680:	24882202 	and	s1,s1,v0
    4684:	3402c28f 	lw	v0,564(s8)
    4688:	25204000 	move	a0,v0
    468c:	d614000c 	jal	0x5358
    4690:	00000000 	nop
    4694:	25284000 	move	a1,v0
    4698:	3c02c38f 	lw	v1,572(s8)
    469c:	00111000 	sll	v0,s0,0x4
    46a0:	2800c427 	addiu	a0,s8,40
    46a4:	21108200 	addu	v0,a0,v0
    46a8:	380251ac 	sw	s1,568(v0)
    46ac:	00111000 	sll	v0,s0,0x4
    46b0:	2800c427 	addiu	a0,s8,40
    46b4:	21108200 	addu	v0,a0,v0
    46b8:	3c0245ac 	sw	a1,572(v0)
    46bc:	01000226 	addiu	v0,s0,1
    46c0:	00110200 	sll	v0,v0,0x4
    46c4:	2800c427 	addiu	a0,s8,40
    46c8:	21108200 	addu	v0,a0,v0
    46cc:	300243ac 	sw	v1,560(v0)
    46d0:	01000226 	addiu	v0,s0,1
    46d4:	00110200 	sll	v0,v0,0x4
    46d8:	2800c327 	addiu	v1,s8,40
    46dc:	21106200 	addu	v0,v1,v0
    46e0:	10000324 	li	v1,16
    46e4:	340243ac 	sw	v1,564(v0)
    46e8:	2d000010 	b	0x47a0
    46ec:	00000000 	nop
    46f0:	63000424 	li	a0,99
    46f4:	3d0c000c 	jal	0x30f4
    46f8:	00000000 	nop
    46fc:	f003c327 	addiu	v1,s8,1008
    4700:	5000c28f 	lw	v0,80(s8)
    4704:	00110200 	sll	v0,v0,0x4
    4708:	08004224 	addiu	v0,v0,8
    470c:	21186200 	addu	v1,v1,v0
    4710:	2802c48f 	lw	a0,552(s8)
    4714:	4402c227 	addiu	v0,s8,580
    4718:	25308000 	move	a2,a0
    471c:	25286000 	move	a1,v1
    4720:	25204000 	move	a0,v0
    4724:	e10e000c 	jal	0x3b84
    4728:	00000000 	nop
    472c:	5002c38f 	lw	v1,592(s8)
    4730:	5402c28f 	lw	v0,596(s8)
    4734:	1000a3af 	sw	v1,16(sp)
    4738:	1400a2af 	sw	v0,20(sp)
    473c:	4402c58f 	lw	a1,580(s8)
    4740:	4802c68f 	lw	a2,584(s8)
    4744:	4c02c78f 	lw	a3,588(s8)
    4748:	25200000 	move	a0,zero
    474c:	740a000c 	jal	0x29d0
    4750:	00000000 	nop
    4754:	12004010 	beqz	v0,0x47a0
    4758:	00000000 	nop
    475c:	64000424 	li	a0,100
    4760:	3d0c000c 	jal	0x30f4
    4764:	00000000 	nop
    4768:	5002c38f 	lw	v1,592(s8)
    476c:	4402c48f 	lw	a0,580(s8)
    4770:	4802c28f 	lw	v0,584(s8)
    4774:	ff004230 	andi	v0,v0,0xff
    4778:	1000a2af 	sw	v0,16(sp)
    477c:	25388000 	move	a3,a0
    4780:	25306000 	move	a2,v1
    4784:	25280000 	move	a1,zero
    4788:	5000c48f 	lw	a0,80(s8)
    478c:	f209000c 	jal	0x27c8
    4790:	00000000 	nop
    4794:	65000424 	li	a0,101
    4798:	3d0c000c 	jal	0x30f4
    479c:	00000000 	nop
    47a0:	5000c28f 	lw	v0,80(s8)
    47a4:	01004224 	addiu	v0,v0,1
    47a8:	5000c2af 	sw	v0,80(s8)
    47ac:	60ff0010 	b	0x4530
    47b0:	00000000 	nop
    47b4:	5802c28f 	lw	v0,600(s8)
    47b8:	5ffe4010 	beqz	v0,0x4138
    47bc:	00000000 	nop
    47c0:	67000424 	li	a0,103
    47c4:	3d0c000c 	jal	0x30f4
    47c8:	00000000 	nop
