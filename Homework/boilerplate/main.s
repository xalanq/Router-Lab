...
$LBB21 = .
	...
	sw	$0,48($fp)
$L62:
	.loc 2 299 0 is_stmt 0 discriminator 3
	lw	$3,48($fp)
	lui	$2,%hi(out_len)
	lw	$2,%lo(out_len)($2)
	sltu	$2,$3,$2
...
$LBE21 = .
	...
	.loc 2 307 0 discriminator 2
	lui	$2,%hi(out_len)
	lw	$2,%lo(out_len)($2)
	addiu	$3,$2,-20
	lui	$2,%hi(out_len)
	sw	$3,%lo(out_len)($2)
	.loc 2 308 0 discriminator 2
	lw	$2,44($fp)
	addiu	$2,$2,1
	andi	$2,$2,0x00ff
	sll	$2,$2,4
...
$LBB24 = .
	...
	sw	$0,68($fp)
$L66:
	.loc 2 319 0 is_stmt 0 discriminator 3
	lw	$3,68($fp)
	lui	$2,%hi(out_len)
	lw	$2,%lo(out_len)($2)
	sltu	$2,$3,$2
	...
	.loc 2 320 0 is_stmt 1 discriminator 2
	lui	$2,%hi(output)
	addiu	$3,$2,%lo(output)
	lw	$2,68($fp)
	addu	$2,$3,$2
