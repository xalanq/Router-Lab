...
$LBB11 = .
	...
	sw	$0,16($fp)
$L26:
	.loc 2 138 0 is_stmt 0 discriminator 3
	lw	$2,48($fp)
	lw	$3,0($2)
	lw	$2,16($fp)
	sltu	$2,$2,$3
...
$LBB13 = .
	...
	sw	$0,16($fp)
$L32:
	.loc 2 155 0 is_stmt 0 discriminator 3
	...
	.loc 2 156 0 is_stmt 1 discriminator 2
	lui	$4,%hi(rtable)
	lw	$3,16($fp)
	move	$2,$3
	sll	$2,$2,2
...
$LBB24 = .
	...
	sw	$0,48($fp)
$L67:
	.loc 2 337 0 is_stmt 0 discriminator 3
	lw	$3,48($fp)
	lui	$2,%hi(out_len)
	lw	$2,%lo(out_len)($2)
	sltu	$2,$3,$2
	...
	.loc 2 338 0 is_stmt 1 discriminator 2
	lui	$2,%hi(output)
	addiu	$3,$2,%lo(output)
	lw	$2,48($fp)
	addu	$2,$3,$2
...
$LBB25 = .
	...
	sw	$0,64($fp)
$L70:
	.loc 2 348 0 is_stmt 0 discriminator 3
	lw	$2,64($fp)
	slt	$2,$2,4
	beq	$2,$0,$L69
	nop

	.loc 2 349 0 is_stmt 1 discriminator 2
	lw	$4,64($fp)
	jal	_Z9broadcasti
	nop
...
$LBB29 = .
	...
	sw	$0,68($fp)
$L74:
	.loc 2 363 0 is_stmt 0 discriminator 1
	lw	$2,68($fp)
	slt	$2,$2,4
	beq	$2,$0,$L73
	nop
