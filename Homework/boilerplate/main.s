...
$LBB5 = .
	...
	sw	$0,16($fp)
$L9:
	.loc 2 66 0 is_stmt 0 discriminator 3
	lw	$2,16($fp)
	lw	$3,32($fp)
	addu	$2,$3,$2
	lb	$2,0($2)
	...
	.loc 2 67 0 is_stmt 1 discriminator 2
	lw	$2,16($fp)
	lw	$3,32($fp)
	addu	$2,$3,$2
	lb	$2,0($2)
...
$LBB6 = .
	...
	sw	$0,4($fp)
$L15:
	.loc 2 88 0 is_stmt 0 discriminator 3
	lw	$3,4($fp)
	lw	$2,20($fp)
	slt	$2,$3,$2
	beq	$2,$0,$L14
...
$L36:
	...
	li	$3,16			# 0x10
$L37:
	.loc 2 172 0 is_stmt 1 discriminator 2
	lw	$5,56($fp)
	sll	$2,$16,4
	addu	$2,$5,$2
	sw	$17,8($2)
...
$LBB21 = .
	...
	sw	$0,48($fp)
$L62:
	.loc 2 271 0 is_stmt 0 discriminator 3
	lw	$3,48($fp)
	lui	$2,%hi(out_len)
	lw	$2,%lo(out_len)($2)
	sltu	$2,$3,$2
	...
	.loc 2 272 0 is_stmt 1 discriminator 2
	lui	$2,%hi(output)
	addiu	$3,$2,%lo(output)
	lw	$2,48($fp)
	addu	$2,$3,$2
...
$LBB24 = .
	...
	sw	$0,68($fp)
$L66:
	.loc 2 291 0 is_stmt 0 discriminator 3
	lw	$3,68($fp)
	lui	$2,%hi(out_len)
	lw	$2,%lo(out_len)($2)
	sltu	$2,$3,$2
	...
	.loc 2 292 0 is_stmt 1 discriminator 2
	lui	$2,%hi(output)
	addiu	$3,$2,%lo(output)
	lw	$2,68($fp)
	addu	$2,$3,$2
