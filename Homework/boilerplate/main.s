...
$LBB5 = .
	...
	sw	$0,16($fp)
$L9:
	.loc 2 55 0 is_stmt 0 discriminator 3
	lw	$2,16($fp)
	lw	$3,32($fp)
	addu	$2,$3,$2
	lb	$2,0($2)
	...
	.loc 2 56 0 is_stmt 1 discriminator 2
	lw	$2,16($fp)
	lw	$3,32($fp)
	addu	$2,$3,$2
	lb	$2,0($2)
...
$LBB6 = .
	...
	sw	$0,4($fp)
$L14:
	.loc 2 72 0 is_stmt 0 discriminator 3
	lw	$3,4($fp)
	lw	$2,20($fp)
	slt	$2,$3,$2
	beq	$2,$0,$L13
...
$LBB11 = .
	...
	sw	$0,16($fp)
$L25:
	.loc 2 117 0 is_stmt 0 discriminator 3
	lw	$2,48($fp)
	lw	$3,0($2)
	lw	$2,16($fp)
	sltu	$2,$2,$3
...
$LBB13 = .
	...
	sw	$0,16($fp)
$L31:
	.loc 2 134 0 is_stmt 0 discriminator 3
...
$L35:
	...
	li	$3,16			# 0x10
$L36:
	.loc 2 149 0 is_stmt 1 discriminator 2
	lw	$5,56($fp)
	sll	$2,$16,4
	addu	$2,$5,$2
	sw	$17,8($2)
...
$LFB32 = .
	...
	.type	main, @function
main:
	.frame	$fp,2232,$31		# vars= 2176, regs= 4/0, args= 40, gp= 0
	.mask	0xc0030000,-4
	.fmask	0x00000000,0
	.set	noreorder
	.set	nomacro
...
$LBB19 = .
	...
	sw	$0,44($fp)
$L60:
	.loc 2 239 0 is_stmt 0 discriminator 3
	lw	$2,44($fp)
	slt	$2,$2,4
	beq	$2,$0,$L59
	nop

	.loc 2 240 0 is_stmt 1 discriminator 2
	lui	$2,%hi(output+28)
...
$LBB31 = .
	...
	sw	$0,68($fp)
$L82:
	.loc 2 330 0 is_stmt 0 discriminator 4
	lw	$3,1808($fp)
	lw	$2,68($fp)
	sltu	$2,$2,$3
	beq	$2,$0,$L79
